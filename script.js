document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateField(field) {
    ...
    const minLength = field.getAttribute('minlength') ? parseInt(field.getAttribute('minlength'), 10) : null;
    const maxLength = field.getAttribute('maxlength') ? parseInt(field.getAttribute('maxlength'), 10) : null;
    ...
    if (type === 'tel' && !validatePhone(trimmed)) {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      if (field.type === 'submit' || field.type === 'button' || field.type === 'reset' || field.hidden) return;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "tupac666 משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'f6502abd-8d66-4a4f-b7bd-19c3146c8add',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'f6502abd-8d66-4a4f-b7bd-19c3146c8add';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f6502abd-8d66-4a4f-b7bd-19c3146c8add';
